...
const presets = {
    ...
    all: { count: 100, rotate: true, drift: true, tiltWithDrift: false, speedRange: [0.1, 1], sizeRange: [50, 100], opacity: 1, rotateSwingRange: 15, rotateSpeed: 0.015, driftAmount: 0.2 },
};
