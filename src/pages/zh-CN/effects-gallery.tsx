        ...
        >
          <Box>
            <Box display={"flex"} justifyContent={"space-between"}>
              ...
              >
                {effect.titles && effect.titles["zh-CN"]
                  ? effect.titles["zh-CN"]
                  : ""}
              </Link>
              <Typography
            ...
            <Typography
              color={"#6e6e6e"}
              title={
                effect.descriptions && effect.descriptions["zh-CN"]
                  ? effect.descriptions["zh-CN"]
                  : ""
              }
              display={"-webkit-box"}
              overflow={"hidden"}
      ...
      <Layout>
        <NextSeo
          ...
          languageAlternates={[
            {
              hrefLang: "en",
              href: "https://funcreveal.github.io/effects-gallery/",
            },
            {
              hrefLang: "zh-TW",
